...
public class Main {
    ...
    public static String gerarMenuSecretaria(Scanner scanner, Secretaria secretaria){
        ...
        Disciplina disciplina1 = new Disciplina(1,"A",25,50,60, Status.ATIVA);
        Disciplina disciplina2 = new Disciplina(2,"B",25,50,60, Status.ATIVA);
        Disciplina disciplina3 = new Disciplina(3,"C",25,50,60, Status.ATIVA);
